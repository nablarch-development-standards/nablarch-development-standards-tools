...
#  User         : batchuser
#  Usage        : func_mail_send.sh JOB_ID REQUEST_PATH USER_ID [PARAM_MAP_ENTRY]... [PARAM_LIST_ITEM]...
#                     JOB_ID
#                       ジョブID
#                     REQUEST_PATH
#                       リクエストパス
...
### 実行オプションの生成 ###
NAB_OPT="-classpath ${RUNTIME_CLASSPATH} ${MAIL_OPT} ${INP_NAB_OPT} "
...
### Mainクラス引数を設定 ###
MAIN_ARGS="-diConfig ${MAIL_DI_CONF}"
